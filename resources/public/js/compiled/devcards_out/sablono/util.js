...
var len__25873__auto___31628 = arguments.length;
var i__25874__auto___31629 = (0);
while(true){
if((i__25874__auto___31629 < len__25873__auto___31628)){
args__25880__auto__.push((arguments[i__25874__auto___31629]));

var G__31630 = (i__25874__auto___31629 + (1));
i__25874__auto___31629 = G__31630;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq31627){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31627));
});
...
var vec__31634 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__31636;
var words = seq__31635__$1;
...
var G__31638 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__31638,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__31638;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__31639_SHARP_){
if(typeof p1__31639_SHARP_ === 'string'){
return p1__31639_SHARP_;
} else {
return cljs.core.seq.call(null,p1__31639_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1483385718570
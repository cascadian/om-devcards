...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__25422__auto__,k34218,else__25423__auto__){
var self__ = this;
var this__25422__auto____$1 = this;
var G__34220 = (((k34218 instanceof cljs.core.Keyword))?k34218.fqn:null);
switch (G__34220) {
case "splicing?":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k34218,else__25423__auto__);
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__34217){
var self__ = this;
var G__34217__$1 = this;
return (new cljs.core.RecordIter((0),G__34217__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__25427__auto__,k__25428__auto__,G__34217){
var self__ = this;
var this__25427__auto____$1 = this;
var pred__34221 = cljs.core.keyword_identical_QMARK_;
var expr__34222 = k__25428__auto__;
if(cljs.core.truth_(pred__34221.call(null,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__34222))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__34217,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34221.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),expr__34222))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,G__34217,self__.__meta,self__.__extmap,null));
} else {
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__25428__auto__,G__34217),null));
}
}
});
...
cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__25419__auto__,G__34217){
var self__ = this;
var this__25419__auto____$1 = this;
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,G__34217,self__.__extmap,self__.__hash));
});
...
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__34219){
return (new cljs.tools.reader.impl.utils.ReaderConditional(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366).cljs$core$IFn$_invoke$arity$1(G__34219),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(G__34219),null,cljs.core.dissoc.call(null,G__34219,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),new cljs.core.Keyword(null,"form","form",-1624062471)),null));
});
...
var iter__25578__auto__ = (function cljs$tools$reader$impl$utils$namespace_keys_$_iter__34241(s__34242){
return (new cljs.core.LazySeq(null,(function (){
var s__34242__$1 = s__34242;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__34242__$1);
if(temp__4657__auto__){
var s__34242__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__34242__$2)){
var c__25576__auto__ = cljs.core.chunk_first.call(null,s__34242__$2);
var size__25577__auto__ = cljs.core.count.call(null,c__25576__auto__);
var b__34244 = cljs.core.chunk_buffer.call(null,size__25577__auto__);
if((function (){var i__34243 = (0);
while(true){
if((i__34243 < size__25577__auto__)){
var key = cljs.core._nth.call(null,c__25576__auto__,i__34243);
cljs.core.chunk_append.call(null,b__34244,((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword)))?(function (){var vec__34251 = cljs.core.juxt.call(null,cljs.core.namespace,cljs.core.name).call(null,key);
var key_ns = cljs.core.nth.call(null,vec__34251,(0),null);
var key_name = cljs.core.nth.call(null,vec__34251,(1),null);
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34244),cljs$tools$reader$impl$utils$namespace_keys_$_iter__34241.call(null,cljs.core.chunk_rest.call(null,s__34242__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34244),null);
}
} else {
var key = cljs.core.first.call(null,s__34242__$2);
return cljs.core.cons.call(null,((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword)))?(function (){var vec__34254 = cljs.core.juxt.call(null,cljs.core.namespace,cljs.core.name).call(null,key);
var key_ns = cljs.core.nth.call(null,vec__34254,(0),null);
var key_name = cljs.core.nth.call(null,vec__34254,(1),null);
var __GT_key = (((key instanceof cljs.core.Symbol))?cljs.core.symbol:cljs.core.keyword);
if((key_ns == null)){
return __GT_key.call(null,ns,key_name);
} else {
...
})():key),cljs$tools$reader$impl$utils$namespace_keys_$_iter__34241.call(null,cljs.core.rest.call(null,s__34242__$2)));
}
} else {
return null;
}
...
cljs.tools.reader.impl.utils.second_SINGLEQUOTE_ = (function cljs$tools$reader$impl$utils$second_SINGLEQUOTE_(p__34258){
var vec__34262 = p__34258;
...
//# sourceMappingURL=utils.js.map?rel=1483385722173